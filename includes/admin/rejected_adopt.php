...
$centers = $conn->query(
    "SELECT rescue_center_id, center_name 
     FROM rescue_center 
...
<title>Rejected Adoption Requests</title>
<link rel="stylesheet" href="rejected_adopt.css">
...
<h2 class="page-title">Rejected Adoption Requests</h2>
    ...
    <select name="rescue_center">
        ...
        <?php while($c=$centers->fetch_assoc()): ?>
            <option value="<?= $c['rescue_center_id'] ?>"
                <?= $rescueCenter==$c['rescue_center_id']?'selected':'' ?>>
...
<?php while($row=$result->fetch_assoc()): ?>
    <div class="animal-card">
        ...
        <div class="adopt-details">
            ...
            <p><b>Rejected On:</b> <?= date("d M Y", strtotime($row['request_date'])) ?></p>
        </div>
...
<p style="text-align:center;font-weight:bold;">
    No rejected adoption requests found
</p>
<?php endif; ?>
