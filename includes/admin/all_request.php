...
<link rel="stylesheet" href="all_request.css">
...
elseif($row['status']=='Completed') echo ' completed';
else echo ' rejected';
?>">
<?= $row['status'] ?>
</span>
...
<?php else: ?>
<p style="text-align:center;font-weight:bold;">No rescue requests found</p>
<?php endif; ?>
